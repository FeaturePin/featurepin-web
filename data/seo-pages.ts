export type Block =
  ...
  | { kind: 'stat'; num: string; label: string }
  | { kind: 'callout'; title: string; text: string }
  | { kind: 'modular'; items: { num: string; title: string; body: string }[] }
  | { kind: 'solve' }
...
export const PAGES: Record<string, SeoPage> = {
  "all-features": {
    ...
    meta: [["Updated", "May 2026"], ["For", "Product Managers, founders"], ["Setup", "5 minutes"]],
    ...
    sections: [
      { id: "announce", title: "Announce mode", body: [
      ...
      { id: "nudge", title: "Nudge mode", body: [
        ...
        { kind: "ol", items: ["Choose the feature area by URL pattern.", "Set the inactivity window (e.g. 14 days since last visit).", "Pick the message type and write the copy.", "Activate — FeaturePin handles the rest."] },
        { kind: "p", text: "Nudges stop showing the moment the user visits the feature. No repeated messages, no manual cleanup." },
      ]},
      { id: "targeting", title: "Targeting and segmentation", body: [
        { kind: "modular", items: [
      ...
      { id: "sdk", title: "SDK and install", body: [
      ...
      { id: "analytics", title: "Campaign analytics", body: [
      ...
      { id: "pricing", title: "Pricing model", body: [
  ...
  "feature-adoption-nudges": {
    ...
    meta: [["Reading time", "6 min"], ["Updated", "May 2026"], ["For", "Product Managers, founders"]],
    ...
    sections: [
      { id: "what-it-is", title: "What a feature adoption nudge actually is", body: [
      ...
      { id: "why-teams-need-them", title: "Why SaaS teams need them", body: [
      ...
      { id: "how-to-build-one", title: "How to build a nudge that gets used", body: [
        { kind: "ol", items: ["Pick a feature with low adoption but clear value.", "Define who should see the nudge and who should never see it.", "Choose one in-product surface close to the action.", "Write copy that is specific, short, and useful."] },
      ...
      { id: "patterns", title: "Patterns worth copying", body: [
        { kind: "modular", items: [
      ...
      { id: "mistakes", title: "Mistakes that make nudges annoying", body: [
        { kind: "ul", items: ["Showing the same nudge to users who already adopted the feature.", "Using modal copy for a tooltip and forcing users to read too much.", "Launching several nudges in the same session and competing with yourself.", "Treating every feature like a company-wide event."] },
        { kind: "blockquote", text: "If your nudge feels like marketing, it will be ignored like marketing.", cite: "FeaturePin rule of thumb" },
      ]},
      { id: "measuring", title: "Measuring whether a nudge worked", body: [
      ...
      { id: "faq-nudges", title: "Common questions about nudges", body: [
  ...
  "in-app-announcements": {
    ...
    meta: [["Reading time", "5 min"], ["Updated", "May 2026"], ["For", "Product, growth, customer success"]],
    ...
    sections: [
      { id: "why-it-works", title: "Why in-app announcements work better than email alone", body: [
        ...
        { kind: "ul", items: ["Better visibility than email for routine product updates.", "Less friction than asking engineering to code launch-specific UI.", "Faster iteration when the copy or targeting needs to change."] },
      ]},
      { id: "choose-the-format", title: "Choose the right format", body: [
        { kind: "modular", items: [
      ...
      { id: "copy", title: "How to write announcement copy", body: [
        { kind: "p", text: "State what changed, why it matters, and what to do next. That is enough. You do not need a launch speech." },
        { kind: "ol", items: ["Lead with the practical change.", "Keep the body to one short paragraph.", "Use one CTA if action matters, otherwise let users dismiss and continue."] },
      ]},
      { id: "targeting-announcements", title: "Targeting your announcements", body: [
      ...
      { id: "when-to-announce", title: "When announcements are enough, and when they are not", body: [
      ...
      { id: "examples", title: "Examples of solid in-app announcements", body: [
        { kind: "ul", items: [
      ...
      { id: "lifecycle", title: "Managing announcements over time", body: [
      ...
      { id: "combine-announce-nudge", title: "Combine announcements with nudges for higher adoption", body: [
  ...
  "featurepin-for-fintech-saas": {
    ...
    meta: [["Reading time", "5 min"], ["Updated", "May 2026"], ["For", "Heads of Product, founders"]],
    ...
    sections: [
      { id: "why-fintech-is-different", title: "Why fintech has a different bar", body: [
        ...
        { kind: "ul", items: ["Security teams want a narrow implementation surface.", "Compliance teams want clarity on what data is collected.", "Product teams still need to improve feature discovery and rollout communication."] },
      ]},
      { id: "what-featurepin-does", title: "What FeaturePin does differently", body: [
      ...
      { id: "where-it-fits", title: "Where fintech teams use it", body: [
        { kind: "modular", items: [
      ...
      { id: "fintech-data-and-compliance", title: "Data collection and compliance posture", body: [
        ...
        { kind: "ul", items: ["Data collected: end-user ID, campaign ID, event type (impression/click/dismiss), timestamp, URL.", "Data not collected: names, email addresses, financial data, device fingerprints, DOM snapshots.", "Storage: events are retained in your workspace only, no third-party analytics pipeline."] },
      ]},
      { id: "fintech-setup-and-approval", title: "What a typical approval process looks like", body: [
      ...
      { id: "review-process", title: "What makes approval easier", body: [
  ...
  "featurepin-vs-userguiding": {
    ...
    meta: [["Reading time", "5 min"], ["Updated", "May 2026"], ["For", "SaaS teams under 80 people"]],
    ...
    sections: [
      { id: "quick-answer", title: "The short answer", body: [
        { kind: "ul", items: ["Choose UserGuiding if you want a multi-feature product adoption suite.", "Choose FeaturePin if your primary problem is feature visibility and adoption.", "Choose neither if your product is too early for tooling and basic customer contact still works better than in-app systems."] },
      ]},
      { id: "overlap", title: "Where they overlap", body: [
      ...
      { id: "difference", title: "Where the difference shows up", body: [
        { kind: "modular", items: [
      ...
      { id: "pricing-ug", title: "Pricing: what you are actually paying for", body: [
      ...
      { id: "when-userguiding-wins", title: "When UserGuiding is the better choice", body: [
      ...
      { id: "setup-and-ongoing-maintenance", title: "Setup, onboarding, and ongoing maintenance", body: [
      ...
      { id: "how-to-decide", title: "How to decide honestly", body: [
  ...
  "featurepin-vs-beamer": {
    ...
    meta: [["Reading time", "4 min"], ["Updated", "May 2026"], ["For", "PMs and founders comparing options"]],
    ...
    sections: [
      { id: "shared-ground", title: "What both products do well", body: [
      ...
      { id: "where-featurepin-wins", title: "Where FeaturePin is stronger", body: [
        { kind: "ul", items: ["Behavioral nudges for users who did not adopt a feature after launch.", "A product position centered on announcements plus nudges, not just release broadcasting.", "A simpler buying story for teams that care more about adoption than changelog presentation."] },
      ]},
      { id: "pricing-comparison", title: "Pricing comparison", body: [
      ...
      { id: "where-beamer-fits", title: "When Beamer may still fit better", body: [
      ...
      { id: "beamer-feature-comparison", title: "What each tool covers", body: [
        { kind: "modular", items: [
      ...
      { id: "beamer-migration", title: "Switching from Beamer", body: [
      ...
      { id: "decision-rule", title: "A practical decision rule", body: [
  ...
  "campaign-analytics": {
    ...
    meta: [["Updated", "May 2026"], ["For", "Product Managers, founders"], ["Included in", "All plans"]],
    ...
    sections: [
      { id: "three-events", title: "The three events that matter", body: [
      ...
      { id: "dashboard", title: "The analytics dashboard", body: [
      ...
      { id: "benchmarks", title: "What good numbers look like", body: [
      ...
      { id: "improving", title: "How to improve campaign performance", body: [
        { kind: "p", text: "Analytics are useful only if they inform a next action. Here are the most common improvement levers." },
        { kind: "ol", items: ["Narrow the audience. The more specific the targeting, the higher the click-through rate. If you are targeting all users, try narrowing to users who have visited the relevant section at least once in the last 30 days.", "Move the format. A tooltip fires in the right context. A modal fires on login. If the feature is specific to a section, a tooltip in that section will outperform a modal on the dashboard.", "Shorten the copy. If users are dismissing quickly, they are probably not reading the body. Cut the message to two sentences and test whether CTR improves.", "Check the CTA label. Specific labels outperform generic ones. 'Try the export feature' converts better than 'Learn more'.", "Review the inactivity window for nudges. A 14-day window may include users who are just infrequent. Try 21 or 30 days for features users only need occasionally."] },
      ]},
      { id: "workspace-analytics", title: "Workspace-level analytics", body: [
  ...
  "featurepin-for-hr-saas": {
    ...
    meta: [["Reading time", "6 min"], ["Updated", "May 2026"], ["For", "Heads of Product, founders"]],
    ...
    sections: [
      { id: "hr-adoption-problem", title: "The HR software adoption pattern", body: [
      ...
      { id: "use-cases-hr", title: "Where HR teams use FeaturePin", body: [
        { kind: "modular", items: [
      ...
      { id: "hr-specific-targeting", title: "Targeting in multi-role HR products", body: [
      ...
      { id: "hr-roi", title: "The adoption ROI for HR teams", body: [
  ...
  "featurepin-for-marketing-saas": {
    ...
    sections: [
      { id: "marketing-saas-challenge", title: "The marketing tool adoption challenge", body: [
      ...
      { id: "use-cases-marketing", title: "Where marketing tool teams use FeaturePin", body: [
        { kind: "modular", items: [
      ...
      { id: "targeting-marketers", title: "Targeting marketing tool users effectively", body: [
      ...
      { id: "marketing-saas-retention", title: "How activation affects retention in marketing SaaS", body: [
  ...
  "featurepin-for-devtools": {
    ...
    meta: [["Reading time", "6 min"], ["Updated", "May 2026"], ["For", "Heads of Product, developer advocates"]],
    ...
    sections: [
      { id: "devtools-audience", title: "What makes developer tool users different", body: [
      ...
      { id: "devtools-use-cases", title: "Where devtools companies use FeaturePin", body: [
        { kind: "modular", items: [
      ...
      { id: "sdk-fit-devtools", title: "Why the SDK fits developer tool stacks", body: [
      ...
      { id: "devtools-tone", title: "Writing for a developer audience", body: [
  ...
  "feature-adoption-guide": {
    ...
    meta: [["Reading time", "10 min"], ["Updated", "May 2026"], ["By", "FeaturePin"]],
    ...
    sections: [
      { id: "definition", title: "Define the metric before you discuss the result", body: [
      ...
      { id: "common-mistakes-metrics", title: "Common mistakes when measuring adoption", body: [
        ...
        { kind: "ul", items: ["Including all users in the denominator instead of eligible users. If a feature is admin-only and your user base is 80 percent non-admins, your adoption rate will look artificially low.", "Measuring first use but not repeat use. A feature that every user tries once and abandons is not adopted. It is merely noticed. Adoption means the feature becomes part of the workflow.", "Using a fixed calendar month as the window instead of a rolling period from each user's first exposure. Users who signed up mid-month had less time to discover the feature.", "Not controlling for users who were not active during the measurement window. If a user did not log in during the period, their non-adoption is not a signal about your feature — it is a signal about their engagement with the product overall."] },
      ...
      { id: "numbers", title: "Three numbers worth tracking", body: [
        { kind: "ol", items: ["Eligible-user adoption: who used it at least once.", "Time to first use: how long it took after launch.", "Repeat usage: whether the feature became part of the workflow."] },
      ]},
      { id: "why-adoption-stalls", title: "Why adoption stalls after launch", body: [
      ...
      { id: "distribution-failure", title: "The three distribution failures", body: [
        ...
        { kind: "ul", items: ["Awareness failure: the user does not know the feature exists. Fix with in-app announcements at launch. Email alone will miss 70 percent of your active users.", "Understanding failure: the user saw the announcement but did not understand why the feature matters to them specifically. Fix with more specific copy and tighter targeting. The more relevant the message feels, the higher the read rate.", "Timing failure: the user heard about the feature but was not ready to try it when the message arrived. Fix with nudges that fire later, when the user is in the relevant section of the product."] },
      ...
      { id: "moves", title: "The four moves that improve adoption", body: [
        { kind: "modular", items: [
      ...
      { id: "benchmarks", title: "What good adoption looks like", body: [
        ...
        { kind: "ul", items: ["Day-7 adoption for a major feature: 25 to 50 percent of eligible active users.", "Day-30 adoption with an active nudge campaign: 50 to 75 percent.", "Repeat usage within 30 days among first-time users: 40 to 70 percent for habitual features.", "In-app modal CTR for a well-targeted launch: 25 to 45 percent.", "Tooltip nudge CTR in the right context: 15 to 35 percent."] },
      ...
      { id: "close", title: "What to do this week", body: [
